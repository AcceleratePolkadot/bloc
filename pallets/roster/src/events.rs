...
mod events {
    ...
    pub enum Event<T: Config> {
        ...
        RosterStatusChanged { changed_by: T::AccountId, roster_id: RosterId, new_status: RosterStatus },
        ...
        NominationClosed { nominee: T::AccountId, closed_by: T::AccountId, roster_id: RosterId, status: NominationStatus },
        /// Vote added to nomination [voter, vote value, nominee, roster id]
        Voted { voter: T::AccountId, vote: NominationVoteValue, nominee: T::AccountId, roster_id: RosterId},
        ...
        NewExpulsionProposal { motioner: T::AccountId, subject: T::AccountId, roster_id: RosterId, reason: ExpulsionReason<T> },
        /// Expulsion Proposal has been seconded [seconder, motioner, subject, roster id, number of seconds]
        SeconderAddedToExpulsionProposal { seconder: T::AccountId, motioner: T::AccountId, subject: T::AccountId, roster_id: RosterId, seconds_count: u32 },
        ...
        ExpulsionVoteSubmitted { voter: T::AccountId, motioner: T::AccountId, subject: T::AccountId, roster_id: RosterId, vote: ExpulsionProposalVoteValue },
        /// Vote added to expulsion proposal [voter, motioner, subject, roster id]
        ExpulsionVoteRecanted { voter: T::AccountId, motioner: T::AccountId, subject: T::AccountId, roster_id: RosterId },
        /// Expulsion proposal has been dismissed with prejudice [closer, motioner, subject, roster id]
        ExpulsionProposalDismissedWithPrejudice { closer: T::AccountId, motioner: T::AccountId, subject: T::AccountId, roster_id: RosterId },
        /// Expulsion proposal has been dismissed [closer, motioner, subject, roster id]
        ExpulsionProposalDismissed { closer: T::AccountId, motioner: T::AccountId, subject: T::AccountId,roster_id: RosterId },
        /// Expulsion proposal has passed [closer, motioner, subject, roster id]
        ExpulsionProposalPassed { closer: T::AccountId, motioner: T::AccountId, subject: T::AccountId,roster_id: RosterId },
    }
}
