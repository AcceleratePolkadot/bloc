...
mod config {
	...
	pub trait Config: frame_system::Config {
        ...
        /// If this period expires and a proposal has not been seconded it can be closed with prejudice
        #[pallet::constant]
        ...
        /// Period in which an account can not motion or second a new proposal after a previous proposal was dismissed with prejudice
        #[pallet::constant]
        type ExpulsionProposalLockoutPeriod: Get<BlockNumberFor<Self>>;

        /// Percentage of total members voting nay required to dismiss an expulsion proposal with prejudice
        #[pallet::constant]
